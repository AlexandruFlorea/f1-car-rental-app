...
class LoginTestCase(TestCase):
    ...
    def test_login_redirects_to_homepage(self):
        ...
        self.assertRedirects(response, '/', status_code=200, target_status_code=200)
    ...
    def test_login_redirects_to_next_url(self):
        ...
        self.assertRedirects(response, reverse('users:profile'), status_code=200, target_status_code=200)
